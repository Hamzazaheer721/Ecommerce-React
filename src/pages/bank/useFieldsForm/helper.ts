...
//   if (isEmpty(acc_holder_mobile_number)) {
//     errors.acc_holder_mobile_number = 'Please enter account holder number'
//   }

//   if (isEmpty(passport_number)) {
//     errors.passport_number = 'Please enter your passport number'
//   }

//   if (isEmpty(swift_code)) {
//     errors.swift_code = 'Please enter your swift code'
//   }

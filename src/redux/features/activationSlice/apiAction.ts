...
import { IActivationErrorRtn, IActivationPayloadRtn, IActivationThunkArgType } from './types'

export const activateAccount = createAsyncThunk<
  IActivationPayloadRtn,
  IActivationThunkArgType,
  { rejectValue: IActivationErrorRtn }
>(
  'activation/activateAccount',
  async (data: IActivationThunkArgType, thunkAPI) => {
    try {
